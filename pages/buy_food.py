...
def buy_food_page(page: ft.Page):
    ...
    search_input = ft.TextField(
        ...
        width=600,
        on_change=lambda e: search_products(e.control.value),  # Фильтрация продуктов по введенному тексту
    ...
    back_button = ft.ElevatedButton(
        content=ft.Text("Назад", size=24),
        style=ft.ButtonStyle(
            bgcolor=button_cancel_color,
            shape=ft.RoundedRectangleBorder(radius=12),
            padding=ft.Padding(20, 10, 20, 10),
    ...
    confirm_button = ft.ElevatedButton(
        content=ft.Text("Подтвердить", size=24),
        style=ft.ButtonStyle(
            ...
            ft.Row(
                controls=[
                    ...
                    ft.Container(
                        content=ft.Column(
                            controls=[
                                ft.Text("Покупка продуктов", size=32, weight=ft.FontWeight.BOLD, color=primary_color),
                    ...
                    ft.Container(
                        content=ft.Column(
                            controls=[
                                ...
                                ft.Row(
                                    controls=[confirm_button, back_button],
                                    alignment=ft.MainAxisAlignment.CENTER,
                                    spacing=20,
                                ),
                            ],
